...
var databaseFill = require("./databasebuild.js");
console.log(databaseFill);

unirest
  .get(
    "https://spoonacular-recipe-food-nutrition-v1.p.rapidapi.com/recipes/findByIngredients?limitLicense=false&number=1"
  )
  .header(
    "X-RapidAPI-Key",
    "61e322562amshd210c32f5fc5e7ap110214jsn192a18e4cb92"
  )
  ...
  .end(function(result) {
    ...
    for (
      var i = 0;
      i < result.body.recipes[0].extendedIngredients.length;
      i++
    ) {
      var ingredient = {};
      ingredient.name = result.body.recipes[0].extendedIngredients[
        i
      ].name.toLowerCase();
      ingredient.spoonID = result.body.recipes[0].extendedIngredients[i].id;
      ingredient.img =
        "https://spoonacular.com/cdn/ingredients_100x100/" +
        result.body.recipes[0].extendedIngredients[i].image;
